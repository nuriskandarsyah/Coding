...
class DBConnection:
    ...
    def __init__(self):
        ...
        self.port = 3306
        self.name = 'freedb_iskandar' #Isi databasename Anda sesuai yang ada di freedb
        self.user = 'freedb_iskandar' #Isi Username Anda sesuai yang ada di freedb
        self.password = 'ztzkW2puv@G%95R' #Isi Password Anda sesuai yang ada di freedb
        self.conn = None
        self.cursor = None
        self.result = None
