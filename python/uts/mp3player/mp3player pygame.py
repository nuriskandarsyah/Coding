...
from PyQt5.QtGui import QGradient, QFont, QColor, QCursor
import pygame

class Window(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('Wumbo MP3 Player')
        pygame.init()
        pygame.mixer.init()
        self.playlist = []
        ...
        # Set the background color of the list widget to black and font color to white
        self.music_list.setStyleSheet("background-color: black; color: white;")

        # Set the text color of status and track labels to white
        self.status.setStyleSheet("color: white;")
        self.track.setStyleSheet("color: white;")
    ...
    def _header(self):
        ...
        font = QFont('Montserrat', 40, QFont.Bold)
    ...
    def _right(self):
        ...
        self.status.setStyleSheet('padding: 5px; color: white;')  # Set warna font di sini
        self.music_list.setStyleSheet('background-color: black;')
    ...
    def _footer(self):
        ...
        font = QFont('Montserrat', 10, QFont.Bold)

        text = scene.addText('WUmbo')
        text.setDefaultTextColor(QColor(250, 250, 250))
        text.setFont(font)
